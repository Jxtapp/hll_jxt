...
import com.hll.jxtapp.StudentInfoActivity;
import com.hll.util.GetWHUtil;

public class RightMoveView extends ViewGroup{
	...
	private RightMenuView right_show_view;
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			synchronized (RightMoveView.this) {
	...
	public RightMoveView(Context context) {
		super(context);
		this.context = context;
		initView();
	}

	public RightMoveView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		initView();
	}
//	public RightMoveView(StudentInfo studentInfo, RightMoveView m) {
//		super(studentInfo);
//		this.studentInfo = studentInfo;
//		initView();
//	}
	public RightMoveView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param currentTab
	 */
	public void setMainView(BaseView mainView,RightMenuView rightView,int curTab){
...
//		}
	...
	protected void onLayout(boolean arg0, int arg1, int arg2, int arg3, int arg4) {
		if (move_state == MOVE_TO_REST) {
			if (now_state == MAIN) {
				...
				right_show_view.getView().layout(0, 0, w, screen_h);
	...
	public void moveToLeft(boolean b) {
		...
		if (!b) {
			...
			right_show_view.getView().layout(0, 0, screen_w, screen_h);
...
//	public BaseView getLeft_show_view() {
